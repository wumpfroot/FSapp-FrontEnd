...
import igtext from './images/640px-Instagram_logo.svg.png'

export const NavBar = () => {
    return (
        <nav>
            <div className="nav-container">
            <img className="nav-logo" src={igtext} alt="instagram navigation logo"/>
            <div id='searchBar'>
            <img className="search-icon" src={searchicon} alt="search icon" />
            <input className="nav-input" type="text" placeholder="Search" />
            </div>
            <div className='nav-links'>
            <svg aria-label='Home' height='24px' width='24px'>
                <path d="M22 23h-6.001a1 1 0 01-1-1v-5.455a2.997 2.997 0 10-5.993 0V22a1 1 0 01-1 1H2a1 1 0 01-1-1V11.543a1.002 1.002 0 01.31-.724l10-9.543a1.001 1.001 0 011.38 0l10 9.543a1.002 1.002 0 01.31.724V22a1 1 0 01-1 1z"></path>
            </svg>
            <svg aria-label='Messaging' height='24px' width='24px'>
                <line fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" x1="22" x2="9.218" y1="3" y2="10.083"></line>
                <polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></polygon>
            </svg>
            <svg aria-label='New Post' width='24px' height='24px'>
            ...
            <svg aria-label='Find People' width='24px' height='24px'>
            ...
            <svg aria-label='Activity Feed' width='24px' height='24px'>
